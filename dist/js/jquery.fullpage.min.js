    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function addSlidesNavigation(section, numSlides){
            section.append('<div class="' + SLIDES_NAV + '"><div class="slideTimeline"></div><ul></ul></div>');
            var nav = section.find(SLIDES_NAV_SEL);
            var sectionNames = ['Start','Research','Ideation','Low-Fi','Mockups','Prototyping','Build','Test','Launch','Relax','Analytics'];

            //top or bottom
            nav.addClass(options.slidesNavPosition);

            for(var i=0; i< numSlides; i++){
                nav.find('ul').append('<li><a href="#" class="navSlide' + i + '"><span class="navDot"><span class="sectionTitle">' + sectionNames[i] + '</span></span></a></li>');
            }
            nav.find('ul').append('<img src="http://liamsheppard.com/wp-content/themes/liamsheppard2016/process/img/iteration.svg" alt="Analytics" class="iteration-timeline"></img><span class="iteration-timeline-infinity">Iterate</span>');
